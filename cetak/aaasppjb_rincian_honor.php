<?php
	...
	$cetak = "
		...
		<br /><br />
		<span style='font-size: 9pt;'>Hal : " . $record["keterangan"] . "</span><br /><br />
		...
		<table width='100%' cellspacing='0' cellpadding='0' style='font-size: 9pt; table-layout: fixed;' border='0'>
			...
			<tr>
				<td align='center' style=''>" . $record["pangkat_diketahui"] . " NRP " . $record["nik_diketahui"] . "</td>
				<td align='center' style=''>" . $record["pangkat"] . " NRP " . $record["nik"] . "</td>
			</tr>
		</table>
		<br />
