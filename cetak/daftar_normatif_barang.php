<?php
	...
	$tulisan_mengetahui = ($konf_kpa["nama_pegawai"] != "") ? "Mengetahui" : "";
	...
	$cetak = "
		...
		<br /><br />
		<table width='100%' border='1' cellspacing='0' cellpadding='1' style='border-collapse: collapse; font-size: 8pt; text-transform: uppercase;'>
			<thead>
				<tr align='center'>
					<th width='30px'>NO</th>
		...
		<table width='100%' cellspacing='0' cellpadding='0' style='font-size: 9pt; table-layout: fixed; page-break-inside:avoid;' border='0'>
			<tr>
				<td align='center'>" . $tulisan_mengetahui . "</td>
