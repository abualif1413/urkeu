...
<div class="alert alert-info">
	<div style="font-weight: bold; font-size: 130%;"><i class="fa fa-tags"></i> Ubah TTD Dokumen</div>
</div>
<form method="post" action="" id="frm_anggaran" onsubmit="return go_save();" style="padding: 20px;">
	...
	<div class="row">
		<div class="col-sm-3 form-group">
			...
			<input type="date" name="tanggal" id="tanggal" class="form-control form-required" value="{{ ttd.tanggal }}" />
		</div>
		<div class="col-sm-9 form-group">
			<label class="control-label">Keterangan (Ketikkan || untuk memberi baris baru)</label>
			<input type="text" name="judul_ttd" id="judul_ttd" class="form-control form-required" value="{{ ttd.judul_ttd }}" />
		</div>
	</div>
	<div class="row">
