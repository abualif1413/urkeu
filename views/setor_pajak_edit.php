...
{% block content %}
	...
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Ubah data penyetoran pajak</li>
		</ol>
	</div><!--/.row-->
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Ubah data penyetoran pajak</h1>
		</div>
	</div><!--/.row-->
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form method="post" action="">
				<input type="hidden" name="id_penyetoran_pajak" value="{{ head.id }}" />
			...
			<form method="post" id="frm_setor_pajak" action="" onsubmit="return go_simpan();">
				...
				<div class="row">
					<div class="form-group col-sm-2">
						...
						<input type="date" name="tgl_setor" id="tgl_setor" class="form-control form-required" value="{{ head.tanggal }}" />
					</div>
					<div class="form-group col-sm-10">
						<label>No. Referensi</label>
						<input type="nomor" name="nomor" id="nomor" class="form-control form-required" value="{{ head.nomor }}" />
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-12">
						<label>Uraian / keterangan</label>
						<textarea class="form-control form-required" name="keterangan" id="keterangan">{{ head.keterangan }}</textarea>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-12">
