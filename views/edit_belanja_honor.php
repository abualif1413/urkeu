...
{% block content %}
	<script type="text/javascript" charset="utf-8">
		...
		function go_edit(id) {
			document.location.href = "edit_belanja_honor_proses.php?id=" + id;
		}
	...
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Edit Belanja Honor</li>
		</ol>
	</div><!--/.row-->
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Edit Belanja Honor</h1>
		</div>
	</div><!--/.row-->
	...
	<div class="panel panel-primary">
		<div class="panel-heading">Data Belanja Honor</div>
		<div class="panel-body">
