...
{% block content %}
	<div class="row">
		<ol class="breadcrumb">
			...
			{% else %}
				<li class="active">Belanja Perjalanan Dinas</li>
			{% endif %}
		</ol>
	</div><!--/.row-->
	<div class="row">
		<div class="col-lg-12">
			{% if pd == "" %}
				<h1 class="page-header">Belanja Barang</h1>
			{% else %}
				<h1 class="page-header">Belanja Perjalanan Dinas</h1>
			{% endif %}
		...
		<div class="panel-body">
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="text" name="na_bulan" id="na_bulan" class="form-control" placeholder="cth : VIII" />
					</div>
					<div class="col-sm-1">
						<input type="text" name="na_tahun" id="na_tahun" class="form-control" placeholder="cth : 2018" />
					</div>
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<select name="jenis_belanja" id="jenis_belanja" class="form-control">
							...
							{% if pd == "" %}
								...
								<option value="belanja pengadaan">Belanja Pengadaan</option>
								<option value="belanja pemeliharaan">Belanja Pemeliharaan</option>
							{% else %}
								<option value="belanja perjalanan dinas">Belanja Perjalanan Dinas</option>
							{% endif %}
						</select>
					</div>
				</div>
