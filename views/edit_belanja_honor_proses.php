...
{% block content %}
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Ubah Belanja Honor</li>
		</ol>
	</div><!--/.row-->
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Ubah Belanja Honor</h1>
		</div>
	</div><!--/.row-->
	<script type="text/javascript" charset="utf-8">
		...
		function go_delete(id) {
			if(confirm("Yakin akan menghapus data?")) {
				document.location.href = "?delete=1&id=" + id + "&id_belanja_honor={{ id }}";
			}
		}
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="input-group">
                            <input type="hidden" class="form-control" placeholder="Search" name="id_pegawai_ybs" id="id_pegawai_ybs" value="{{data.id_pegawai_ybs}}-{{data.id_pegawai_ybs_riwayat}}">
                            <input type="text" class="form-control" placeholder="Search" name="pegawai_ybs" id="pegawai_ybs" readonly="readonly" value="{{data.nama_pegawai}} - {{ data.jabatan }}">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="input-group">
                            <input type="hidden" class="form-control" placeholder="Search" name="diketahui_oleh" id="diketahui_oleh" value="{{data.diketahui_oleh}}-{{data.diketahui_oleh_riwayat}}">
                            <input type="text" class="form-control" placeholder="Search" name="pegawai_do" id="pegawai_do" readonly="readonly" value="{{data.nama_pegawai_diketahui}} - {{ data.jabatan_diketahui }}">
                            <div class="input-group-btn">
