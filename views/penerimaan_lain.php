...
<div class="row">
	<ol class="breadcrumb">
		...
		<li class="active">Penerimaan Lain-Lain</li>
	</ol>
</div><!--/.row-->
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Penerimaan Lain-Lain</h1>
	</div>
</div><!--/.row-->	
<div class="panel panel-primary">
	<div class="panel-heading">Data Penerimaan Lain-Lain</div>
...
<div class="panel panel-primary">
	<div class="panel-heading">Daftar Penerimaan Lain-Lain</div>
	<div class="panel-body">
