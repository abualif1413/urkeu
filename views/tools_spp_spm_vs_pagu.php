...
{% block content %}
	...
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Angka SPP / SPM vs Pagu</li>
		</ol>
	</div><!--/.row-->
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Angka SPP / SPM vs Pagu</h1>
		</div>
	</div><!--/.row-->
				...
				<table width="100%" class="table table-condensed table-striped table-hover" cellspacing="0" cellpadding="0" style="font-size: 85%;">
					<thead>
						<tr class="bg-primary">
							<th width="20px"></th>
							<th width="30px">No.</th>
							<th width="150px">No. / Tgl.<br />SPP/SPM</th>
							<th width="120px">Jenis Belanja</th>
							<th>Uraian</th>
							<th width="300px">Total SPM vs Pagu</th>
						</tr>
					</thead>
					<tbody>
						{% set no = 0 %}
