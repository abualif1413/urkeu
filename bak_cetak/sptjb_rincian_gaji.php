<?php
	...
	$rincian = BelanjaGajiModel::GetTotalList($_GET["id"]);
	
	$tbl = "";
	$no = 0;
	$total_jumlah = $rincian["total_dibayar"];
	$total_ppn = 0;
	$total_pph = $rincian["nilai_pph"];
	
		$no++;
		$tbl .= "<tr>";
			$tbl .= "<td align='right'>1</td>";
			$tbl .= "<td>Para Pegawai</td>";
	...
	$cetak = "
		...
		<table cellspacing='0' cellpadding='0' style='text-transform: uppercase; font-size: 9pt; margin-left: 20px;' width='100%'>
			...
			<tr>
				...
				<td width='10px'>:</td>
				<td>5 Desember 2017 / 060.01.2.640384/2018</td>
			</tr>
			<tr>
		...
		<table width='100%' cellspacing='0' cellpadding='0' style='font-size: 9pt; table-layout: fixed;' border='0'>
			<tr>
				<td align='center' style='font-weight: bold;'>KUASA PENGGUNA ANGGARAN /</td>
				<td align='center'>Medan, " . tanggal_indonesia_panjang($record["tanggal"]) . "</td>
			</tr>
			<tr>
				<td align='center' style='font-weight: bold;'>PEJABAT PEMBUAT KOMITMEN</td>
